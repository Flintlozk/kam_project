...
!(function (e, t) {
  ...
  function o(e, t) {
    'template' !== e.tagName.toLowerCase()
      ...
      : 1 !== e.content.childElementCount &&
        console.warn(`Alpine: <template> tag with [${t}] encountered with multiple element roots. Make sure <template> only has a single child element.`);
  }
  function a(e) {
  ...
  function u(e, t, n = {}) {
    return 'function' == typeof e
      ? e.call(t)
      : new Function(['$data', ...Object.keys(n)], `var __alpine_result; with($data) { __alpine_result = ${e} }; return __alpine_result`)(t, ...Object.values(n));
  }
  ...
  function m(e, t, n) {
    let i = Array.from(e.attributes).filter(f).map(p),
      r = i.filter((e) => 'spread' === e.type)[0];
    if (r) {
      let e = u(r.expression, t.$data);
      i = i.concat(Object.entries(e).map(([e, t]) => p({ name: e, value: t })));
    }
    return n
      ? i.filter((e) => e.type === n)
      : (function (e) {
  ...
  function x(e, t, n, i, r = !1) {
    ...
    if (o && o.modifiers.includes('transition')) {
      ...
      s.some((e) => ['enter', 'enter-start', 'enter-end'].includes(e.value))
        ? (function (e, t, n, i, r) {
            const s = v(O((n.find((e) => 'enter' === e.value) || { expression: '' }).expression, e, t)),
  ...
  function _(e, t, n, i, r = !1) {
    ...
    if (o && o.modifiers.includes('transition')) {
      ...
      s.some((e) => ['leave', 'leave-start', 'leave-end'].includes(e.value))
        ? (function (e, t, n, i, r) {
            const s = v(O((n.find((e) => 'leave' === e.value) || { expression: '' }).expression, e, t)),
  ...
  const O = (e, t, n) => ('function' == typeof e ? n.evaluateReturnExpression(t, e) : e);
  ...
  function P(e, t, i, r, s) {
    ...
    let a = C('function' == typeof i ? e.evaluateReturnExpression(t, i) : i),
      l = (function (e, t, n, i) {
        ...
        S(s) && s > 0 && (s = Array.from(Array(s).keys(), (e) => e + 1));
        return s;
      })(e, t, a, s),
      c = t;
    l.forEach((i, o) => {
  ...
  function T(e, t, n, i, r, s = {}) {
    ...
    if ((i.includes('camel') && (n = a(n)), i.includes('away'))) {
      let a = (l) => {
        t.contains(l.target) || (t.offsetWidth < 1 && t.offsetHeight < 1) || (L(e, r, l, s), i.includes('once') && document.removeEventListener(n, a, o));
      };
                ...
                ((function (e) {
                  ...
                  (function (e, t) {
                    ...
                    if (n.includes('debounce')) {
                      ...
                      n.splice(e, S((n[e + 1] || 'invalid-wait').split('ms')[0]) ? 2 : 1);
                    }
                    ...
                    if (((n = n.filter((e) => !i.includes(e))), i.length > 0)) {
                      if (i.filter((t) => (('cmd' !== t && 'super' !== t) || (t = 'meta'), e[t + 'Key'])).length === i.length && n[0] === N(e.key)) return !1;
                    }
                    return !0;
                  })(c, i)) ||
    ...
    return (
      ...
      (n, i) => {
        ...
        if ('select' === e.tagName.toLowerCase() && e.multiple)
          return t.includes('number') ? Array.from(n.target.selectedOptions).map((e) => R(e.value || e.text)) : Array.from(n.target.selectedOptions).map((e) => e.value || e.text);
        {
  ...
  const { isArray: F } = Array,
    ...
    { push: Z, concat: J, map: Q } = Array.prototype;
  function X(e) {
    return void 0 === e;
  }
  function Y(e) {
  ...
  const ne = (e) => ee.get(e) || e;
  function ie(e, t) {
    return e.valueIsObservable(t) ? e.getProxy(t) : t;
  }
  function re(e, t, n) {
    J.call(K(n), G(n)).forEach((i) => {
      let r = W(n, i);
  ...
  function le(e) {
    let t = void 0;
    return F(e) ? (t = []) : 'object' == typeof e && (t = {}), t;
  }
      ...
      return (
        (i = {
          get reactive() {
            const n = new se(r, t),
              i = new Proxy(le(t), n);
            return te(i, e), B(this, 'reactive', { value: i }), i;
          },
          get readOnly() {
            const n = new ae(r, t),
              i = new Proxy(le(t), n);
            return te(i, e), B(this, 'readOnly', { value: i }), i;
          },
        }),
        n.set(t, i),
        i
  ...
  class ve {
    ...
    initializeElement(e, t) {
      e.hasAttribute('class') && m(e, this).length > 0 && (e.__x_original_classes = v(e.getAttribute('class'))),
        ...
        switch (i) {
          ...
          case 'model':
            !(function (e, t, i, r, s) {
              ...
              T(e, t, o, i, `${r} = rightSideOfExpression($event, ${r})`, () => n(n({}, s()), {}, { rightSideOfExpression: z(t, i, r) }));
            })(this, e, s, o, t);
        }
      });
    }
          ...
          if (n && n.isSameNode(this.$el)) {
            ...
            e[t].addedNodes.length > 0 &&
              e[t].addedNodes.forEach((e) => {
                1 !== e.nodeType || e.__x_inserted_me || (!e.matches('[x-data]') || e.__x ? this.initializeElements(e) : (e.__x = new ve(e)));
              });
          }
        }
