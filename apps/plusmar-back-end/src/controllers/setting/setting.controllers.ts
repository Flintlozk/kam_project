...
import { validateRequestPageID, validateResponseHTTPObject, validateSubscriptionIDValidate } from '../../schema/common';
import {
...
class Setting {
  ...
  async saveCompanyInfoHandler(parent, args, context: IGQLContext): Promise<IHTTPResult> {
    ...
    return await Setting.settingService.saveCompanyInfo(args.info, pageID, subscriptionID, pageUUID);
  }
