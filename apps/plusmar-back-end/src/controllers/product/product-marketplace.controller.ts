...
import { ProductMarketPlaceService } from '@reactor-room/itopplus-services-lib';
import { environment } from '../../environments/environment';
import {
  validateIdNumberArrayOperationObject,
  validateIDNumberObject,
  validateNameFieldArray,
  validateRequestPageID,
  validateResponseHTTPArray,
  validateResponseHTTPObject,
  validateTextStringObject,
} from '../../schema/common';
import {
