...
import { EnumPaymentType, EnumAuthScope, EnumSubscriptionFeatureType } from '@reactor-room/itopplus-model-lib';
import {
  Payment2C2PService,
...
class Payment {
  ...
  // )
  // async updatePaymentDetailHandler(parent, args, context: IGQLContext) {}
...
export const paymentResolver = {
  Mutation: {
    // add: graphQLHandler({
    //   handler: payment.addHandler,
    //   validator: validateResponsePaymentSetting,
    // }),

    // updatePaymentDetail: graphQLHandler({
    //   handler: payment.updatePaymentDetailHandler,
    //   validator: validateResponsePaymentSetting,
    // }),
