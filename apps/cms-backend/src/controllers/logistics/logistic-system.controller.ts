...
import { validateLogisticSystemInput } from '../../schema/settings/logistics/logistics.schema';
import { validateLogisticList } from '../../schema/settings/logistics/logistics.schema';
...
export const logisticSystemResolver = {
  Mutation: {
    saveLogisticSystemSetting: graphQLHandler({
      ...
      validator: validateLogisticSystemInput,
    }),
    toggleLogisticSystemSetting: graphQLHandler({
      handler: logisticSystem.saveLogisticSystemSettingHandler,
      validator: validateLogisticList,
    }),
  },
};
