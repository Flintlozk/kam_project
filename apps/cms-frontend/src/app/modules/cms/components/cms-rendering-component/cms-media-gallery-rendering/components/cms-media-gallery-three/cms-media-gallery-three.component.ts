...
@Component({
  selector: 'cms-next-cms-media-gallery-three',
  templateUrl: './cms-media-gallery-three.component.html',
  styleUrls: ['./cms-media-gallery-three.component.scss'],
})
export class CmsMediaGalleryThreeComponent implements OnInit, OnChanges {
