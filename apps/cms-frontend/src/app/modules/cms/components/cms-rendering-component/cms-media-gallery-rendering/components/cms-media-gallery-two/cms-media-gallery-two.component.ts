...
@Component({
  selector: 'cms-next-cms-media-gallery-two',
  templateUrl: './cms-media-gallery-two.component.html',
  styleUrls: ['./cms-media-gallery-two.component.scss'],
})
export class CmsMediaGalleryTwoComponent implements OnInit, OnChanges {
