...
@Component({
  selector: 'cms-next-cms-content-comment-count-landing',
  templateUrl: './cms-content-comment-count-landing.component.html',
  styleUrls: ['./cms-content-comment-count-landing.component.scss'],
})
export class CmsContentCommentCountLandingComponent implements OnInit, OnDestroy {
  destroy$ = new Subject();
