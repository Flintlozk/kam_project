...
@Component({
  selector: 'cms-next-cms-content-view-count-landing',
  templateUrl: './cms-content-view-count-landing.component.html',
  styleUrls: ['./cms-content-view-count-landing.component.scss'],
})
export class CmsContentViewCountLandingComponent implements OnInit, OnDestroy {
  destroy$ = new Subject();
