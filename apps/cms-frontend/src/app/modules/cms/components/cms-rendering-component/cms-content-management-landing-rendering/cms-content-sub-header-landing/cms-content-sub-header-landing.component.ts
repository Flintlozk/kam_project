...
@Component({
  selector: 'cms-next-cms-content-sub-header-landing',
  templateUrl: './cms-content-sub-header-landing.component.html',
  styleUrls: ['./cms-content-sub-header-landing.component.scss'],
})
export class CmsContentSubHeaderLandingComponent implements OnInit, OnDestroy {
  destroy$ = new Subject();
