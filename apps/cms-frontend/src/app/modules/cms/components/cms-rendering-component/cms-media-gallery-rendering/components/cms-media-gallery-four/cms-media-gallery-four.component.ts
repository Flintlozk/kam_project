...
@Component({
  selector: 'cms-next-cms-media-gallery-four',
  templateUrl: './cms-media-gallery-four.component.html',
  styleUrls: ['./cms-media-gallery-four.component.scss'],
})
export class CmsMediaGalleryFourComponent implements OnInit, OnChanges {
