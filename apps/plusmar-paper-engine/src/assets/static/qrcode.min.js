...
!(function () {
  function r(t) {
    ...
    for (var e = 0, r = this.data.length; e < r; e++) {
      ...
      65536 < i
        ? ((o[0] = 240 | ((1835008 & i) >>> 18)), (o[1] = 128 | ((258048 & i) >>> 12)), (o[2] = 128 | ((4032 & i) >>> 6)), (o[3] = 128 | (63 & i)))
        : 2048 < i
        ? ((o[0] = 224 | ((61440 & i) >>> 12)), (o[1] = 128 | ((4032 & i) >>> 6)), (o[2] = 128 | (63 & i)))
        : 128 < i
  ...
  (r.prototype = {
          ...
          for (6 == a && a--; ; ) {
            for (var s = 0; s < 2; s++)
              if (null == this.modules[o][a - s]) {
                var h = !1;
                n < t.length && (h = 1 == ((t[n] >>> i) & 1)), _.getMask(e, o, a - s) && (h = !h), (this.modules[o][a - s] = h), -1 == --i && (n++, (i = 7));
              }
    ...
    (h.createData = function (t, e, r) {
      for (var o = p.getRSBlocks(t, e), i = new m(), n = 0; n < r.length; n++) {
        var a = r[n];
        i.put(a.mode, 4), i.put(a.getLength(), _.getLengthInBits(a.mode, t)), a.write(i);
      }
      var s = 0;
      ...
      for (; !(i.getLengthInBits() >= 8 * s || (i.put(h.PAD0, 8), i.getLengthInBits() >= 8 * s)); ) i.put(h.PAD1, 8);
    ...
    (h.createBytes = function (t, e) {
      ...
      var p = new Array(c),
        m = 0;
      for (u = 0; u < o; u++) for (s = 0; s < e.length; s++) u < n[s].length && (p[m++] = n[s][u]);
      for (u = 0; u < i; u++) for (s = 0; s < e.length; s++) u < a[s].length && (p[m++] = a[s][u]);
      return p;
    });
  for (
    var n = { MODE_NUMBER: 1, MODE_ALPHA_NUM: 2, MODE_8BIT_BYTE: 4, MODE_KANJI: 8 },
      ...
      _ = {
        ...
        getBCHTypeInfo: function (t) {
          for (var e = t << 10; 0 <= _.getBCHDigit(e) - _.getBCHDigit(_.G15); ) e ^= _.G15 << (_.getBCHDigit(e) - _.getBCHDigit(_.G15));
          return ((t << 10) | e) ^ _.G15_MASK;
        },
        getBCHTypeNumber: function (t) {
          for (var e = t << 12; 0 <= _.getBCHDigit(e) - _.getBCHDigit(_.G18); ) e ^= _.G18 << (_.getBCHDigit(e) - _.getBCHDigit(_.G18));
          return (t << 12) | e;
        },
        ...
        getErrorCorrectPolynomial: function (t) {
          for (var e = new v([1], 0), r = 0; r < t; r++) e = e.multiply(new v([1, c.gexp(r)], 0));
          return e;
        },
    ...
    c.EXP_TABLE[t] = 1 << t;
  for (t = 8; t < 256; t++) c.EXP_TABLE[t] = c.EXP_TABLE[t - 4] ^ c.EXP_TABLE[t - 5] ^ c.EXP_TABLE[t - 6] ^ c.EXP_TABLE[t - 8];
  for (t = 0; t < 255; t++) c.LOG_TABLE[c.EXP_TABLE[t]] = t;
  function v(t, e) {
  ...
  (v.prototype = {
    ...
    multiply: function (t) {
      for (var e = new Array(this.getLength() + t.getLength() - 1), r = 0; r < this.getLength(); r++)
        for (var o = 0; o < t.getLength(); o++) e[r + o] ^= c.gexp(c.glog(this.get(r)) + c.glog(t.get(o)));
      return new v(e, 0);
    },
    mod: function (t) {
      if (this.getLength() - t.getLength() < 0) return this;
      for (var e = c.glog(this.get(0)) - c.glog(t.get(0)), r = new Array(this.getLength()), o = 0; o < this.getLength(); o++) r[o] = this.get(o);
      for (o = 0; o < t.getLength(); o++) r[o] ^= c.gexp(c.glog(t.get(o)) + e);
    ...
    (p.getRSBlocks = function (t, e) {
      ...
      for (var o = r.length / 3, i = [], n = 0; n < o; n++) for (var a = r[3 * n + 0], s = r[3 * n + 1], h = r[3 * n + 2], l = 0; l < a; l++) i.push(new p(s, h));
      return i;
    }),
  ...
  function E(t, e) {
    for (
      var r,
        ...
        n =
          ...
          (o = encodeURI(r)
            .toString()
            .replace(/\%[0-9a-fA-F]{2}/g, 'a')).length + (o.length != r ? 3 : 0)),
        a = 0,
        s = C.length;
      a <= s;
      a++
    ...
    if (C.length < i) throw new Error('Too long data');
    return i;
  }
  ((QRCode = function (t, e) {
    if (
      ((this._htOption = { width: 256, height: 256, typeNumber: 4, colorDark: '#000000', colorLight: '#ffffff', correctLevel: l.H }), 'string' == typeof e && (e = { text: e }), e)
    )
