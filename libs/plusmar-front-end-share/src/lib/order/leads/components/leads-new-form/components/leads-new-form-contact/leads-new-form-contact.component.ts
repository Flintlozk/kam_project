...
@Component({
  selector: 'reactor-room-leads-new-form-contact',
  templateUrl: './leads-new-form-contact.component.html',
  styleUrls: ['./leads-new-form-contact.component.scss'],
})
export class LeadsNewFormContactComponent implements OnInit {
  ...
  async generateForm(form: ILeadsFormWithComponentsSelected) {
