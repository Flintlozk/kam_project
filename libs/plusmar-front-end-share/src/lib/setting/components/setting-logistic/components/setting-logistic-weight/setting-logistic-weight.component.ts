...
@Component({
  selector: 'reactor-room-setting-logistic-weight',
  templateUrl: './setting-logistic-weight.component.html',
  styleUrls: ['./setting-logistic-weight.component.scss'],
})
export class SettingLogisticWeightComponent implements OnInit {
