...
@Component({
  selector: 'reactor-room-setting-logistic-per-item',
  templateUrl: './setting-logistic-per-item.component.html',
  styleUrls: ['./setting-logistic-per-item.component.scss'],
})
export class SettingLogisticPerItemComponent implements OnInit {
