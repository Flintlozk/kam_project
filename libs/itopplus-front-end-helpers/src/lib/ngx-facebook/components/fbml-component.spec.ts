...
describe('FBMLAttribute', () => {
  let de: DebugElement, comp: FBTestComponent, fixture: ComponentFixture<FBTestComponent>;
  ...
  xit('should add data-test-attr attribute to element', () => {
...
describe('FBMLInstanceMethod', () => {
  ...
  it('should do basic call to instance method', () => {
    jest.spyOn(comp._instance, 'testMethod');
  ...
  it('should do call with args to instance method', () => {
    jest.spyOn(comp._instance, 'testMethodWithArgs');
