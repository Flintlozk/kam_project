import { getUTCDateFromString, getUTCDayjs } from '@reactor-room/itopplus-front-end-helpers';
...
export const validateThirdPartyTokenExpire = (thirdPartyPage: IPagesThirdParty): TokenRefreshByTypes => {
