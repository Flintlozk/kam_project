...
sed 's/_ENV_/'"staging"'/g; s/_PORT_/'"4320"'/g; s/_SIZE_/'"1"'/g; s/_TAG_/'"$CI_PIPELINE_ID"'/g' ./scripts/cms-project/yml/website-generator-handler.tpl.yml > website-generator-handler.yml
